...
def create_app():
    ...
    with app.app_context():
        ...
        otel6 = Otel(isim="Ramada Plaza By Wyndham", yildiz_sayisi=5,toplam_yildiz = 11, ucret=4060, foto="https://lh3.googleusercontent.com/gps-cs-s/AC9h4nr3e-muecahvYEe2yps0hpN4gfNZO-znDCGSlvVJqPPmXD35kPV1Ra-1O9GKY8L_wFD7k8_-pyTA16o0SFu7kFFkNvaKWkV0L9bOd1eucvxxPRAEifPRibjiMX_7vCgU0w05GXU7g=s1360-w1360-h1020-rw", telno="02123154444", sehir_id=sehir2.id)
