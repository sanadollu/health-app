...
def create_app():
    ...
    with app.app_context():
        ...
        otel6 = Otel(isim="Ramada Plaza By Wyndham", yildiz_sayisi=5,toplam_yildiz = 11, ucret=4060, foto="https://dryapi.com.tr/wp-content/uploads/2018/01/17-800x430.jpg", telno="02123154444", sehir_id=sehir2.id)
