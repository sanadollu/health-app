...
def create_app():
    ...
    with app.app_context():
        ...
        otel2 = Otel(isim="Ramada Plaza Antalya", yildiz_sayisi=5,toplam_yildiz = 12, ucret=3060, foto="https://i.neredekal.com/i/neredekal/75/1200x1200/603945b3c1311bd73ab55ba5", telno="02422491111", sehir_id=sehir1.id)
        otel3 = Otel(isim="Prenses Sealine Beach Hotel", yildiz_sayisi=3,toplam_yildiz = 24, ucret=547, foto="https://cdn.neckermann-nordic.se/hotelphotos/amon-hotels-area-0027.jpg", telno="05342188422", sehir_id=sehir1.id)
        ...
        otel12 = Otel(isim="Anemon Ege", yildiz_sayisi=4,toplam_yildiz = 15, ucret=1408, foto="https://anemonhotels.com/wp-content/webp-express/webp-images/uploads/elementor/thumbs/izmir-qzemqos0yc43r7imujn9rqaulaxwc9ks2rp88xnjuo.jpg.webp", telno="02323734862", sehir_id=sehir3.id)
